-- corso
insert into corso values(1, 'JAVA', '12-mag-2020', '15-mag-2021', 1700, 'molto bello', 'a1');
insert into corso values(2, 'PHP', '18-dic-2020', '12-gen-2021', 700, 'poco utile', 'a2');
insert into corso values(3, 'XML', '3-dic-2020', '13-feb-2021', 500, 'utile', 'a3');
insert into corso values(4, 'CSS', '23-set-2020', '16-dic-2020', 800, 'interessante', 'a4');
insert into corso values(5, 'HTML', '5-ott-2020', '14-nov-2020', 450, 'fondamentale', 'a5');
insert into corso values(6, 'JS', '10-lug-2020', '17-lug-2020', 2000, 'molto utile', 'a6');
insert into corso values(7, 'SPRING', '7-mag-2020', '18-mag-2020', 1800, 'istruttivo', 'a7');
insert into corso values(8, 'C', '21-nov-2020', '19-dic-2020', 999, 'formativo', 'a8');
insert into corso values(9, 'PYTHON', '11-nov-2020', '10-mar-2021', 1500, 'troppo mainstream', 'a9');
insert into corso values(10, 'C++', '8-gen-2020', '15-feb-2020', 1099, 'formativo++', 'a10');
